...
modes \addref{DCS mode}, a $\ovE{\bquark}\to\ovE{\cquark}\cquark\ovE{\squark}$
transition dominated by a single weak phase \addref{single weak phase}, and an
easy to reconstruct final state the analysis of \BdToJpsiKS decays is a unique
way to test the \SM quark flavour sector.
...
\caption{Feynman diagrams (left) for the decay of \Bd and (right) \Bdbar into
