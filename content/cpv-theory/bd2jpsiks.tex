...
In principle, the \CP violating phase in the decay of \BdToJpsiKS can be
enhanced by an additional phase $\Delta\phi$ from loop-suppressed penguin
diagrams
%
\begin{equation}
...
a subgroup of the flavour \group{SU}{3}, the $U$-spin symmetry represents the
