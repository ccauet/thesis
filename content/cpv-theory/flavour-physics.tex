...
$\Zboson$ bosons obtain masses after the spontaneous breaking of the symmetry
and substituting the Higgs field by its \VEV
%
...
\end{equation}
%
The Yukawa couplings $Y_{ij}$ are not constraint by the theory and thus are
completely arbitrary, leading to most of the free \SM parameters. The coupling
matrices are a priori non-diagonal in the weak interaction base, but in general
...
%
\begin{equation}
  \ket{\Psi(t)} = \psi_1(t) \ket{\Mesonz} + \psi_2(t) \ket{\Mesonzbar} \eqcm
\end{equation}
%
...
\begin{equation}
  ...
  =
  \begin{pmatrix}
    m_{11} - \frac{\ii}{2} \Gamma_{11}    & m_{12} - \frac{\ii}{2} \Gamma_{12} \\
    m_{21} - \frac{\ii}{2} \Gamma_{21}    & m_{22} - \frac{\ii}{2} \Gamma_{22} \\
  \end{pmatrix}
  \begin{pmatrix}
    \psi_1 \\
    \psi_2
...
$M$ and $\Gamma$, where the Hamiltonian
%
\begin{equation}
  \Hamiltonian{}{} = M - \frac{\ii}{2} \Gamma
\end{equation}
%
...
\begin{equation}
  \begin{split}
    \mu_H &= m_H - \frac{\ii}{2} \Gamma_H\eqcm\eqand \\
    \mu_L &= m_L - \frac{\ii}{2} \Gamma_L\eqpd
  \end{split}
\end{equation}
%
...
%
\begin{equation}
  m = \frac{m_H + m_L}{2} \eqcm \eqand \Gamma = \frac{\Gamma_H + \Gamma_L}{2}\eqcm
\end{equation}
%
and the mass and decay width differences
%
\begin{equation}
  \DM = m_H - m_L \eqcm \eqand \DG = \Gamma_H - \Gamma_L\eqpd
\end{equation}
%
...
%
% \begin{equation}
%   \left(\frac{q}{p}\right)^2 = \frac{m_{12}^{\ast} - \frac{\ii}{2} \Gamma_{12}^{\ast}}{m_{12} - \frac{\ii}{2} \Gamma_{12}}
% \end{equation}
%
...
\begin{equation}
  ...
  =
  \frac{1}{2} \left[
    \exponential{-\ii m_H t} \exponential{-\frac{1}{2} \Gamma_H t} \pm \exponential{-\ii m_L t} \exponential{-\frac{1}{2} \Gamma_L t}
  \right]\eqpd
\end{equation}
%
