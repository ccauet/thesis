...
\end{table}
%
% \missing{Comparison of $\BuToJpsiK$ and $\BdToJpsiKstarz$ on MC}

% ------------------------------------------------------------------------------
\subsection[
  head={\ac*{SS} tagger calibration using \BdToJpsiKstarz decays},
  tocentry={\ac*{SS} tagger calibration using \BdToJpsiKstarzHyperref decays}
]{\ac*{SS} tagger calibration using \BdToJpsiKstarzbfsf decays}
...
% \missing{\SS calibration: $\BdToJpsiKstarz$ signal selection?}
