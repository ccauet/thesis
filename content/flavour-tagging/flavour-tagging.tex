...
to an integrated luminosity of $\SI{0.37}{\per\femtobarn}$. The data is
categorised into $\num{21}$ bins of $\mistagestimate$ and a linear function is
fit to the data to estimate the calibration parameters $\pzero$ and $\pone$.
%
\begin{figure}
\centering
...
$\mistagestimate$ provided by the tagging algorithms. The black points with
errors are data of $\BuToJpsiK$ decays corresponding to an integrated luminosity
of $\SI{0.37}{\per\femtobarn}$. The red line illustrates the linear calibration
