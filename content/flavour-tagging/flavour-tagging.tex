...
$\tagdecision = -1$ and $\mistagestimate = 1 - P(\bquark)$. As in
\cref{eq:flavour_tagging:combination:product} possible correlation among the
involved taggers is ignored, the joint mistag estimate might distort the
outcome. To correct for this possible bias the combination is calibrated using a
flavour-specific control channel.
...
as of the \SSpi tagger. As the \OS and \SS taggers find their decisions using
independent particle information their output is assumed to be uncorrelated and
not further calibration is necessary after combination of the \OS and \SSpi
tagging decisions.
