...
\important{Wording for \mistag, \mistagestimate and $\mistagestimate_\text{c}$} 
...
requires the knowledge of the \Bmeson flavour at production, \ie weather it
...
\todo{Move FT performance to measurement section?}
...
% https://twiki.cern.ch/twiki/pub/LHCbPhysics/OSCharmTagger/LHCb-ANA-2014-103-DRAFT-17-3-2015.pdf
...
Similar to the \SSpi or \SSK algorithms the newly developed \SSp tagger
\addref{SSp} infers its tagging decision from protons produced in the
fragmentation of the signal \Bmeson.
\missing{SSp performance}
