...
discussion of the \OS and \SS tagging algorithms. Recent developments are
discussed in \cref{sec:flavour_tagging:developments}. Before coming to the
detailed description of the \LHCb flavour tagging algorithms, a summary of the
flavour tagging methods developed at \Babar and \Belle is given.
...
$\bquark$ hadron produced in association with the signal $\B$ meson. If for
...
by looking at the kaon charge that the $\bquark$ hadron produced along with the
$\Bu$ contained a $\bquark$ quark. The tag identification for events with this
