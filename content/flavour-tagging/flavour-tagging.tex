...
algorithms and \cref{sec:flavour_tagging:os,sec:flavour_tagging:ss} contain a
more detailed description of the \OS and \SS tagging algorithms. Recent
developments are discussed in \cref{sec:flavour_tagging:developments}. Before
