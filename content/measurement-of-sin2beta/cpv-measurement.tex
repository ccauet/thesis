...
estimation of the (asymmetric) parameter errors.
...
\redo{Fit results: because it is very ugly}
...
\Cref{fig:measurement_of_sin2beta:cpv_measurement:results:plots:asymmetry} shows
...
\begin{table}[h]
  ...
  asymmetries in the nominal fit\info{all constraint}}
...
background (dotted green) are shown.\todo{Mass and time large, other three smaller below}}
...
the signal PDF.\todo{Larger}}
\label{fig:measurement_of_sin2beta:cpv_measurement:results:plots:asymmetry}
\end{figure}
%
\begin{figure}
\centering
\includegraphics[width=0.48\textwidth]{private/content/measurement-of-sin2beta/figs/LLScan_1D_S.pdf}
\includegraphics[width=0.48\textwidth]{private/content/measurement-of-sin2beta/figs/LLScan_1D_C.pdf}
\caption{One dimensional likelihood profile scans for $\SJpsiKS$ and $\CJpsiKS$.\todo{Put together with 2D plot.}}
\label{fig:measurement_of_sin2beta:cpv_measurement:results:plots:1d_ll_scan}
\end{figure}
%
\begin{figure}
\centering
\includegraphics[width=0.95\textwidth]{private/content/measurement-of-sin2beta/figs/LLScan_2D.pdf}
\caption{Two dimensional likelihood profile scan for $\SJpsiKS$ and $\CJpsiKS$.
The contour lines show the $1\sigma$-$4\sigma$ confidence levels.\todo{2D larger above, two 1D below}}
