...
The fit results of the nominal fit are:
%
\begin{equation}\label{eq:measurement_of_sin2beta:cpv_measurement:results}
  \begin{split}
    \SJpsiKS                &= \phantom{+}0.729\,\pm\,0.035 \ , \\
    \CJpsiKS                &= -0.033\,\pm\,0.032  \ , \\
    \rho(\SJpsiKS,\CJpsiKS) &= \phantom{+}0.483 \ , \\
    \DMd                    &= \phantom{+}0.5100\,\pm\,0.0030 \ (\text{\textit{constrained}}), \\
    \tau                    &= \phantom{+}\SI[separate-uncertainty=true]{1.479 \pm 0.009}{\pico\second} \ . \\
  \end{split}
\end{equation}
...
%
\begin{table}
  \caption{Results for the tagging parameters in the nominal fit}
...
distributions. Shown is the reconstructed mass (top left) and decay time (top
right, logarithmic), per-event mistag (center), and decay time error (bottom,
