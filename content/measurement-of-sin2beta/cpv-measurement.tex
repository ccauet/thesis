...
\begin{table}[h]
  ...
  asymmetries in the nominal fit. All parameters are constraint in the fit as
  described in
...
the signal PDF.\todo{Make tikz plot of CP asymmetry larger}}
...
flavour tagging calibration and production asymmetries.\todo{Make tikz plot of corr matrix larger}}
