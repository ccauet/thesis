...
%
% \begin{multline}
%     \ProbArg{}{}{\obsTimeTrue, \obsTagOS, \obsTagSS \given \mistagOS, \mistagSS} = \\ 
%     \shoveleft{\frac{1}{\Norm{\obsTimeTrue}{}} \exponential{-\sfrac{t}{\tau}}
%     \Biggl\{
...
%         + \left( \SJpsiKS \sin (\DMd \obsTimeTrue) - \CJpsiKS \cos (\DMd \obsTimeTrue) \right) \times \\
%         \shoveleft{\Biggl[
