...
events to \replace{ToyMC}{Macro for ToyMC?} events is calculated and shown in
...
bias due to this choice is investigated in \cref{missing}.\addref{to section where acceptance systematics are studied}
%
\begin{table}
  \centering
