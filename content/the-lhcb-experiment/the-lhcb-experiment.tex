...
The reconstructed of trajectories employs all available tracking information from \VELO, \TT, \OT and \OT, and the muon system.
...
The \PID is crucial ingredient to all major analyses based on \LHCb data. Thus,
...
$\sim\SIrange[range-phrase = -,list-units = single]{1}{3}{\percent}$
