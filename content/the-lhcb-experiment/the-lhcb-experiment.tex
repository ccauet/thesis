...
$\SI{45}{\ps}$ \addref{detector performance from speakers bureau page}.
...
\cref{fig:lhcb_experiment:data:integrated_lumi}.\addref{recorded luminosity and lumi plot from LHCb page}
%
\begin{figure}[t]
  \centering
